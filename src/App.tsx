...
export default function App() {
  ...
  return (
    <div className={`fixed inset-0 w-full h-[100svh] flex flex-col bg-slate-950 font-sans text-slate-100 overflow-hidden select-none transition-colors duration-300 ${theme === "light" ? "light-theme" : ""}`}>
